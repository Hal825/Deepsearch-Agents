...
# 1. 定义你的代理地址和端口
proxies = {
    "http": "http://127.0.0.1:7890",   # 请替换为你的代理地址
    "https": "http://127.0.0.1:7890",  # 请替换为你的代理地址
}

# 2. 将代理配置传递给 Tavily 客户端
tavily_client = TavilyClient(api_key=tavily_key, proxies=proxies)
